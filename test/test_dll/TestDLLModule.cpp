...
extern "C" PLATFORM_EXPORT int  GetTestDLLInitCount()    { return g_test_dll_init_count.load(); }
extern "C" PLATFORM_EXPORT int  GetTestDLLShutdownCount(){ return g_test_dll_shutdown_count.load(); }
extern "C" PLATFORM_EXPORT int  GetTestDLLExecCount()    { return g_test_dll_exec_count.load(); }
extern "C" PLATFORM_EXPORT void SetTestDLLOnInitResult(bool ok) { g_test_dll_oninit_result = ok; }
extern "C" PLATFORM_EXPORT void ResetTestDLLCounters()
{
